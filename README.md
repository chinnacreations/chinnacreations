...
I build scalable and user-focused web applications using modern
...
- Interested in AI, LLMs and Agentic AI
...
- HRMS and enterprise applications
...
Exploring LLMs, RAG, AI agents, tools and agent orchestration.
